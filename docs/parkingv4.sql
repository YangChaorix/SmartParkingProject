...
CREATE TABLE `notification` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` int DEFAULT NULL COMMENT '用户ID', -- 外键 user.id => 1:n
...
CREATE TABLE `parking` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` int DEFAULT NULL COMMENT '用户ID', -- 外键 user.id => 1:n
  `vehicle_id` int DEFAULT NULL COMMENT '车辆ID', -- 外键 vehicle.id
  `location_id` int DEFAULT NULL COMMENT '区域ID', -- 外键 location.id => 1:n
  `parking_lot_id` int DEFAULT NULL COMMENT '车位ID', -- 外键 parking_lot.id => 1:n
...
CREATE TABLE `pay` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` int DEFAULT NULL COMMENT '用户ID', -- 外键 user.id => 1:n
  `vehicle_id` int DEFAULT NULL COMMENT '车辆ID', -- 外键 vehicle.id => 1:n
  `location_id` int DEFAULT NULL COMMENT '区域ID', -- 外键 location.id => 1:n
  `parking_lot_id` int DEFAULT NULL COMMENT '车位ID', -- 外键 parking_lot.id => 1:n
  `start_time` datetime DEFAULT NULL COMMENT '入场时间',
  `end_time` datetime DEFAULT NULL COMMENT '出场时间',
