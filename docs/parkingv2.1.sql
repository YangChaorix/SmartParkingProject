...
CREATE TABLE `parking` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` int DEFAULT NULL COMMENT '用户ID', -- 外键user_id.id
  `vehicle_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '车辆ID', -- 外键vehicle.id
  `location_id` int DEFAULT NULL COMMENT '区域ID',  -- 外键location.id
  `parking_lot_id` int DEFAULT NULL COMMENT '车位ID', -- parking_lot.id
...
CREATE TABLE `pay` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `user_id` int DEFAULT NULL COMMENT '用户ID', -- 外键user.id
  `vehicle_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '车辆ID', -- 外键vehicle.id
  `location_id` int DEFAULT NULL COMMENT '区域ID', -- 外键location.id
  `parking_lot_id` int DEFAULT NULL COMMENT '车位ID', -- 外键parking_lot.id
  `start_time` datetime DEFAULT NULL COMMENT '入场时间',
  `end_time` datetime DEFAULT NULL COMMENT '出场时间',
